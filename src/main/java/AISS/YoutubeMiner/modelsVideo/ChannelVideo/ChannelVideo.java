...
public class ChannelVideo { @JsonProperty("uri")
private String uri;
    @JsonProperty("name")
    private String name;
    ...
    public List<VideoVideo> getVideos() { return videos;}

    public void setVideos(List<VideoVideo> videos) {this.videos = videos;}
